...
public class Server extends AsyncTask<String, Void, String> {
    ...
    public Server(Context context, TextView statusField, TextView roleField, int flag) {
    ...
    protected String doInBackground (String...arg0){
        ...
        if (byGetOrPost == 0) {
            //GET METHOD
            try {
                String NIP = (String) arg0[0];
                String password = (String) arg0[1];

                String link = "http://localhost/GuruGet.php?username=" + NIP + "%password=" + password;
